...
set_property PACKAGE_PIN R2 [get_ports swOp[1]]
set_property PACKAGE_PIN T1 [get_ports swOp[0]]
...
set_property IOSTANDARD LVCMOS33 [get_ports swOp[1]]
set_property IOSTANDARD LVCMOS33 [get_ports swOp[0]]
